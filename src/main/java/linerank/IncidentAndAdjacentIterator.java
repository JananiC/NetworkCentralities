...
public class IncidentAndAdjacentIterator
  ...
  public IncidentAndAdjacentIterator(Vertex<IntWritable, DoubleWritable,
      Directions> vertex) {
    this(vertex.getEdges().iterator());
  }

  public IncidentAndAdjacentIterator(
  ...
  private void lookAhead() {
    ...
    while (edges.hasNext()) {
      ...
      if (nextEdge.getValue().isAdjacent()) {
        currentTargetVertex = nextEdge.getTargetVertexId();
        //System.out.println("Adjacent edge: "+currentTargetVertex.get());
        break;
      }
    }
  }
